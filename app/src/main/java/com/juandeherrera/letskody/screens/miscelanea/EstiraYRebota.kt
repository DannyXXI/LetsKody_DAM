...
import com.juandeherrera.letskody.metodosAuxiliares.componentes.miscelanea.KodyInteractivo
...
@Composable
fun PantallaEstiraRebota(controladorNavegacion: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            // contenedor para la imagen interactiva
            Box(
                modifier = Modifier.fillMaxSize()  // ocupa el espacio disponible
                    .weight(1f)                    // ocupa el espacio restante entre la barra superior y la inferior
            ){
                KodyInteractivo(context = context, scope = scope)
            }
        }
    }
}