...
@Database(
    ...
    entities = [UsuarioData::class, BanderasEuropaData::class, PuntuacionEuroBanderasData::class, PuntuacionNuminario1Data::class, PalabrasPalabrix1Data::class, PuntuacionPalabrix1Data::class], version = 1, exportSchema = true
)
abstract class AppDB: RoomDatabase() {
    ...
    abstract fun palabrasPalabrix1Dao(): PalabrasPalabrix1DAO

    abstract fun puntuacionPalabrix1Dao(): PuntuacionPalabrix1DAO
}