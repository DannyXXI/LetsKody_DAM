...
@Composable
fun CabeceraJuego(segundosCronometro: Int, numeroPregunta: Int, preguntasTotales: Int, puntosActuales: Int, fuenteTipografica: FontFamily) {
...
@Composable
fun BotonOpcion (texto: String, opcionSeleccionada: String?, opcionCorrecta: String, fuenteTipografica: FontFamily, pulsar: () -> Unit) {
